...
from main.forms.image_form import ImageForm
from main.forms.account_form import AccountForm
from main.utils.profile_image import get_base64_image_blob
...
@login_required
def personal_notes(user_id: int):
    with Session() as session:
        personal_notes = session.query(Note).filter(
